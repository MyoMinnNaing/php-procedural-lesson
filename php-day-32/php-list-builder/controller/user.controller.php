...
function index()
{
    ...
    return view("user/index", ["lists" => paginate($sql)]);
    //example out put ===> view/list/index.view.php ကို ပို့ပေးပါတယ်။။ 
    // view function က parameter အနေနဲ့  array တစ်ခုရော သယ်သွားပါတယ်။။
}
