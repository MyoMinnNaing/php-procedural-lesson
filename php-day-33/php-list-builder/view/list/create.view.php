     ...
     <form action="<?= route("list-store")  ?>" method="post">
          <div class="row align-items-end">
               <div class="col">
                    ...
                    <input type="text" name="name" class="form-control <?php echo hasError('name') ? 'is-invalid' : ''   ?>">
               ...
               <div class="col">
                    ...
                    <input type="number" name="money" class="form-control <?php echo hasError('money') ? 'is-invalid' : ''   ?>">
